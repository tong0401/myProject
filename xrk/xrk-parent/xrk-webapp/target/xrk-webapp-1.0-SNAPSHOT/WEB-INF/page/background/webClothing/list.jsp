      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">价格</span></td>
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">描述</td>
          ...
          <tr>
            ...
            <td ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/clothing/getById.html?id=${key.id}&&type=0">${key.name}</a></span></td>
            <td ><span class="STYLE1" style="color: blue;">${key.price}</span></td>
            <td ><span class="STYLE1">${key.description}</span></td>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/clothing/getById.html?id=${key.id}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/clothing/deleteById.html?id=${key.id}');">
            	删除</a>
            	</sec:authorize>
            	</span></td>
          </tr>
