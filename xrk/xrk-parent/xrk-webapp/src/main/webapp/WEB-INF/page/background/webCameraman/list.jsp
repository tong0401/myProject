...
<body>
<form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/cameraman/query.html" method="post">
<table width="100%">
  <tr>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif" ><span class="STYLE1">评论数</span></td>
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">作品数</td>
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">预约数</td>
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">电话</td>
            <td background="${pageContext.servletContext.contextPath }/images/bg.gif"  class="STYLE1">邮箱</td>
          ...
          <tr>
            ...
            <td ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/cameraman/getById.html?id=${key.id}&&type=0">${key.name}</a></span></td>
            <td ><span class="STYLE1" style="color: blue;">${key.evaluationCount}</span></td>
            <td ><span class="STYLE1">${key.productionCount}</span></td>
            <td ><span class="STYLE1">${key.bespeakCount}</span></td>
            <td ><span class="STYLE1">${key.tel}</span></td>
            <td ><span class="STYLE1">${key.email}</span></td>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/cameraman/getById.html?id=${key.id}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/cameraman/deleteById.html?id=${key.id}');">
            	删除</a>
            	</sec:authorize>
            	</span></td>
          </tr>
