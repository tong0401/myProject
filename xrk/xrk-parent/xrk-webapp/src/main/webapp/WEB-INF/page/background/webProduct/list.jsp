      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <td ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/product/getById.html?id=${key.id}&&type=0">${key.name}</a></span></td>
            ...
            <a href="${pageContext.servletContext.contextPath }/background/product/getById.html?id=${key.id}&&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </sec:authorize>
           <sec:authorize ifAnyGranted="ROLE_sys_user_delete">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/product/deleteById.html?id=${key.id}');">
            	删除</a>
            	</sec:authorize>
            	</span></td>
          </tr>
